  ...
  getSwiperSlides() {
    if (this.props.currentStyles[this.props.mainImgIndex] !== undefined) {
      return this.props.currentStyles[this.props.mainImgIndex].photos.map((photo, index) => {
        return (
          <div key={index} id={index} onClick={this.props.setStyleIndex} className="slide-image"><Avatar alt={this.props.currentStyles[this.props.mainImgIndex].name} src={photo.thumbnail_url} /></div>
        );
      });
    }
  }
